                ...
                <div class="row post-grid">
                        ...
                        <div>
                            <div class="form-outline">
                                {{-- <form action="" method="GET"> --}}
                                    <input type="search" id="search" name="search" class="form-control " placeholder="search category" onkeyup="requirements()">
                    ...
                    <div class="col col-md-4">
                        <div class="form-group">
                            <select id="status" class="form-control form-control-md" name="filterStatus" onchange="requirements()">
